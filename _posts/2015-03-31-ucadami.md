...
role: Among other tasks, I took part in this project through the extration of user capabilities by measuring several implicit interaction boundaries; the design, implementation and evaluation of an ontology which models the functional capabilities of the user; the analysis and evaluation of context models and ontologies to be included in the design;    
--- 
